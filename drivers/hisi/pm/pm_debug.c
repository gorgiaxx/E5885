...
void pm_debug_print_stamp(void)
{
	...
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_SUSPEND_BEGIN       =0x%x \n",  *(u32*)STAMP_SECOS_SUSPEND_BEGIN);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_BEFORE_GIC_SUS       =0x%x \n",  *(u32*)STAMP_SECOS_BEFORE_GIC_SUS);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_GIC_SUS       =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_GIC_SUS);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_EDMA_SUS       =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_EDMA_SUS);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_L2_FLUSH       =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_L2_FLUSH);
	...
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_CODE_RES_BEGIN        =0x%x \n",  *(u32*)STAMP_SECOS_CODE_RES_BEGIN);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_BEFORE_DPM_RES		 =0x%x \n",  *(u32*)STAMP_SECOS_BEFORE_DPM_RES);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_L1_ENABLE		 =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_L1_ENABLE);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_SERIAL_RES		 =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_SERIAL_RES);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_DX_RES		 	 =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_DX_RES);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_TIMER_RES		 =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_TIMER_RES);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_EDMA_RES		 =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_EDMA_RES);
	pm_printk(BSP_LOG_LEVEL_ERROR,"STAMP_SECOS_AFTER_GIC_RES		 =0x%x \n",  *(u32*)STAMP_SECOS_AFTER_GIC_RES);
    /*in sleep ASM power up*/
